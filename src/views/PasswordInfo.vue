        ...
        <div class="flex flex-col w-full shadow-lg rounded-lg bg-white py-9">
             <div class="flex flex-col text-center justify-start text-balance">
               ...
               <g>
                  ...
                  <p class="text-sm font-bold text-violet text-center px-6 pt-7">A link was sent to the email you provided. Click on the <span class="text-dark"> <router-link to="/forgotpassword">link </router-link></span>to create  new password.</p>
