            ...
            <div class="flex flex-col space-y-3 p-32">
                ...
                <div>
                    <div class="flex justify-center items-center space-x-5 mt-16">
                        <router-link to="/signup"><button class="items-center flex text-sm mt-4 relative border border-solid border-blue-950 rounded text-blue-950 px-2 py-2 font-semibold  hover:text-white hover:bg-violet">Get Started</button></router-link>
